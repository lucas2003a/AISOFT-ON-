...
INSERT INTO activos (idproyecto, tipo_activo, sublote, direccion, moneda_venta, area_terreno, partida_elect, precio_venta, create_at, idusuario)
VALUES
    (1, 'lote', 2, 'Urbanización Zeta', 'USD', 280.00, 'Partida 027', 95000.00, CURDATE(), 1),
    (1, 'lote', 4, 'Urbanización Kappa', 'USD', 320.00, 'Partida 029', 110000.00, CURDATE(), 2),
    (1, 'lote', 6, 'Urbanización Sigma', 'USD', 300.00, 'Partida 031', 85000.00, CURDATE(), 2),
    (1, 'lote', 8, 'Urbanización Upsilon', 'USD', 380.00, 'Partida 033', 120000.00, CURDATE(), 1),
    (1, 'lote', 10, 'Urbanización Omega', 'USD', 420.00, 'Partida 035', 105000.00, CURDATE(), 3),
    (1, 'lote', 12, 'Urbanización Delta', 'USD', 450.00, 'Partida 037', 115000.00, CURDATE(), 3),
    (1, 'lote', 14, 'Urbanización Gamma', 'USD', 480.00, 'Partida 039', 100000.00, CURDATE(), 2),
    (1, 'lote', 16, 'Urbanización Epsilon', 'USD', 500.00, 'Partida 041', 120000.00, CURDATE(), 2),
    (1, 'lote', 18, 'Urbanización Zeta', 'USD', 300.00, 'Partida 043', 90000.00, CURDATE(), 2),
    (1, 'lote', 20, 'Urbanización Eta', 'USD', 250.00, 'Partida 045', 95000.00, CURDATE(), 1),
    (1, 'lote', 22, 'Urbanización Theta', 'USD', 280.00, 'Partida 047', 110000.00, CURDATE(), 2),
    (1, 'lote', 24, 'Urbanización Iota', 'USD', 320.00, 'Partida 049', 85000.00, CURDATE(), 2),
    (1, 'lote', 26, 'Urbanización Kappa', 'USD', 380.00, 'Partida 051', 120000.00, CURDATE(), 1),
    (1, 'lote', 28, 'Urbanización Lambda', 'USD', 420.00, 'Partida 053', 105000.00, CURDATE(), 3),
    (1, 'lote', 30, 'Urbanización Mu', 'USD', 450.00, 'Partida 055', 115000.00, CURDATE(), 3),
    (1, 'lote', 32, 'Urbanización Nu', 'USD', 480.00, 'Partida 057', 100000.00, CURDATE(), 2),
    (1, 'lote', 34, 'Urbanización Xi', 'USD', 500.00, 'Partida 059', 120000.00, CURDATE(), 2),
    (1, 'lote', 36, 'Urbanización Omicron', 'USD', 300.00, 'Partida 061', 90000.00, CURDATE(), 2),
    (1, 'lote', 38, 'Urbanización Pi', 'USD', 250.00, 'Partida 063', 95000.00, CURDATE(), 1),
    (1, 'lote', 40, 'Urbanización Rho', 'USD', 280.00, 'Partida 065', 110000.00, CURDATE(), 2),
    (1, 'lote', 42, 'Urbanización Sigma', 'USD', 320.00, 'Partida 067', 85000.00, CURDATE(), 2),
    (1, 'lote', 44, 'Urbanización Tau', 'USD', 380.00, 'Partida 069', 120000.00, CURDATE(), 1),
    (1, 'lote', 46, 'Urbanización Upsilon', 'USD', 420.00, 'Partida 071', 105000.00, CURDATE(), 3),
    (1, 'lote', 48, 'Urbanización Phi', 'USD', 450.00, 'Partida 073', 115000.00, CURDATE(), 3),
    (1, 'lote', 50, 'Urbanización Chi', 'USD', 480.00, 'Partida 075', 100000.00, CURDATE(), 2),
    (1, 'lote', 52, 'Urbanización Psi', 'USD', 500.00, 'Partida 077', 120000.00, CURDATE(), 2),
    (1, 'lote', 54, 'Urbanización Omega', 'USD', 300.00, 'Partida 079', 90000.00, CURDATE(), 2),
    (1, 'lote', 56, 'Urbanización Alpha', 'USD', 250.00, 'Partida 081', 95000.00, CURDATE(), 1),
    (1, 'lote', 58, 'Urbanización Beta', 'USD', 280.00, 'Partida 083', 110000.00, CURDATE(), 2),
    (1, 'lote', 60, 'Urbanización Gamma', 'USD', 320.00, 'Partida 085', 85000.00, CURDATE(), 2),
    (1, 'lote', 62, 'Urbanización Delta', 'USD', 380.00, 'Partida 087', 120000.00, CURDATE(), 1),
    (1, 'lote', 64, 'Urbanización Epsilon', 'USD', 420.00, 'Partida 089', 105000.00, CURDATE(), 3),
    (1, 'lote', 66, 'Urbanización Zeta', 'USD', 450.00, 'Partida 091', 115000.00, CURDATE(), 3),
    (1, 'lote', 68, 'Urbanización Eta', 'USD', 480.00, 'Partida 093', 100000.00, CURDATE(), 2),
    (1, 'lote', 70, 'Urbanización Theta', 'USD', 500.00, 'Partida 095', 120000.00, CURDATE(), 2),
    (1, 'lote', 72, 'Urbanización Iota', 'USD', 300.00, 'Partida 097', 90000.00, CURDATE(), 2),
    (1, 'lote', 74, 'Urbanización Kappa', 'USD', 250.00, 'Partida 099', 95000.00, CURDATE(), 1),
    (1, 'lote', 76, 'Urbanización Lambda', 'USD', 280.00, 'Partida 101', 110000.00, CURDATE(), 2),
    (1, 'lote', 78, 'Urbanización Mu', 'USD', 320.00, 'Partida 103', 85000.00, CURDATE(), 2),
    (1, 'lote', 80, 'Urbanización Nu', 'USD', 380.00, 'Partida 105', 120000.00, CURDATE(), 1),
    (1, 'lote', 82, 'Urbanización Xi', 'USD', 420.00, 'Partida 107', 105000.00, CURDATE(), 3),
    (1, 'lote', 84, 'Urbanización Omicron', 'USD', 450.00, 'Partida 109', 115000.00, CURDATE(), 3),
    (1, 'lote', 86, 'Urbanización Pi', 'USD', 480.00, 'Partida 111', 100000.00, CURDATE(), 2),
    (1, 'lote', 88, 'Urbanización Rho', 'USD', 500.00, 'Partida 113', 120000.00, CURDATE(), 2),
    (1, 'lote', 90, 'Urbanización Sigma', 'USD', 300.00, 'Partida 115', 90000.00, CURDATE(), 2),
    (1, 'lote', 92, 'Urbanización Tau', 'USD', 250.00, 'Partida 117', 95000.00, CURDATE(), 1),
    (1, 'lote', 94, 'Urbanización Upsilon', 'USD', 280.00, 'Partida 119', 110000.00, CURDATE(), 2),
    (1, 'lote', 96, 'Urbanización Phi', 'USD', 320.00, 'Partida 121', 85000.00, CURDATE(), 2),
    (1, 'lote', 98, 'Urbanización Chi', 'USD', 380.00, 'Partida 123', 120000.00, CURDATE(), 1),
