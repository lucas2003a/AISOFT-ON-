        ...
        async function renderRefunds(refunds) {
            ...
            new Chart(chartRefunds, {
                ...
                data: {
                    ...
                    datasets: [
                        {
                        data: refundsContracts.map(contract => contract.mes), // * Mes
                        label: refundsContracts.map(contract => contract.cantidad) // * Cantidad de contratos
                    },{
                        data: refundSeparations.map(separation => separation.mes), // * Mes
                        label : refundSeparations.map(separation => separation.cantidad) // * Cantidad Separaciones
                    }
                ]
                },
                options: {
