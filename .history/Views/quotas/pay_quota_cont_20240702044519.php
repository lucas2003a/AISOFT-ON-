  ...
  <script>
    document.addEventListener("DOMContentLoaded", async function() {
      ...
      async function getDataQuota(id) {
        ...
        try {
          ...
          if (result) {
            ...
            $("#monto_pago").value = Number.parseFloat(result.deuda).toFixed(2)
            $("#monto_pago").max = $("#deuda").value;
            $("#monto_pago").min = $("#deuda").value;
      ...
      function getToday() {
        ...
        $("#fecha_pago").value = actual;
        $("#fecha_pago").max = actual;
        $("#fecha_pago").min = actual;
      }
          ...
          form.addEventListener('submit', event => {
            ...
            if (!form.checkValidity()) {
              ...
              sAlert.sweetConfirm("Datos nuevos", "¿Deseas actualizar el registro?", () => {
                ...
                addQuota(idcuota); //Ejecuta la función
              });
            }
