<?php incl "../sidebar/permissions.php"?>
<!DOCTYPE html>
<html lang="es">
              ...
              <td>
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="./detail_contract.php?id=${code}" class="dropdown-item border-radius-md"><i class="bi bi-arrow-right-square text-success"></i> Ver más</a></li>
