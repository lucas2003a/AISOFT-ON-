                  ...
                  <form action="" class="row needs-validation" id="form_det_budget" novalidate>
                    ...
                    <div class="row d-flex align-items-center">
                      ...
                      <div class="col-md-3">
                        ...
                        <input type="number" name="cantidad" id="cantidad" min="0.1" step="0.01" class="form-control" required>
                        <div class="invalid-feedback">
                      ...
                      <div class="col-md-3">
                        ...
                        <input type="number" name="precio_unitario" id="precio_unitario" class="form-control" value="0.00" min="0.1" step="0.01" required>
                        <div class="invalid-feedback">
