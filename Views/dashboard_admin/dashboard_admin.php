...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4">
            ...
            <div class="row mt-4">
                ...
                <!-- /* -------------------------------------------------------------------------- */
                /*                         GRÁFICO DE INGRESOS POR CUOTAS                         */
                /* -------------------------------------------------------------------------- */ -->
                        ...
                        <div class="card-body p-3">
                            <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                                ...
                                <div class="chart  h-100">
                                    <canvas id="chart-line2" class="chart-canvas" height="100"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        const chartQuotas = $("#chart-quotas").getContext("2d");
        const chartDev = $("#chart-dev").getContext("2d");
        ...
        async function getQuotas(){
            ...
            try {
                ...
                params.append("action","chartQuotas");

                let results = await global.sendAction(url, params);

                if(results.length > 0){
                    console.log('results :>> ', results);
                    await renderQuotas(results);
                }
            } catch (e) {
                console.error(e);
            }
        ...
        // * Obtiene el monto de los egresos
